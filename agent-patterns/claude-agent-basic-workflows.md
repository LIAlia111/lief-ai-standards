# Claude Agent Basic Workflows

> 来源: anthropics/claude-cookbooks/patterns/agents/basic_workflows.ipynb
...
tickets = [
    ...
    I'm sure I'm using the right password. Can you help me regain access? This is 
```
